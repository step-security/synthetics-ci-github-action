...
![GitHub Release](https://img.shields.io/github/v/release/step-security/synthetics-ci-github-action)
...
2. In your GitHub workflow, use `step-security/synthetics-ci-github-action`.
  ...
  e2e_testing:
    ...
    steps:
      ...
      - name: Run Datadog Synthetic tests
        uses: step-security/synthetics-ci-github-action@v3
        with:
...
| `locations`               | Override the list of locations to run the test from, separated by new lines or commas. The possible values are listed [in this API response][17]. <br><sub>**Default:** none</sub>                                                                                                                                 |
...
| `raw-results`               | The [`synthetics.Result[]`][18] array, as a JSON-encoded string.                     |
...
[8]: https://github.com/step-security/synthetics-ci-github-action/tags
